...
QUnit.test('weeks year starting wednesday custom', function (assert) {
...
QUnit.test('no leading zeros in long date formats', function (assert) {
...
// locale-specific
QUnit.test('ar-ly strict mode parsing works', function (assert) {
    var m, formattedDate;
