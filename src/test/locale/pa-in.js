...
QUnit.test('weeks year starting sunday', function (assert) {
...
QUnit.test('weeks year starting monday', function (assert) {
...
QUnit.test('weeks year starting tuesday', function (assert) {
...
QUnit.test('weeks year starting wednesday', function (assert) {
...
QUnit.test('weeks year starting thursday', function (assert) {
...
QUnit.test('weeks year starting friday', function (assert) {
...
QUnit.test('weeks year starting saturday', function (assert) {
