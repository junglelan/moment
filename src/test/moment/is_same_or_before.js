...
QUnit.test('is same or before without units', function (assert) {
...
QUnit.test('is same or before year', function (assert) {
...
QUnit.test('is same or before month', function (assert) {
...
QUnit.test('is same or before day', function (assert) {
    var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
...
QUnit.test('is same or before hour', function (assert) {
    var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
...
QUnit.test('is same or before minute', function (assert) {
    var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
...
QUnit.test('is same or before second', function (assert) {
    var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
...
QUnit.test('is same or before millisecond', function (assert) {
    var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
...
QUnit.test('is same with utc offset moments', function (assert) {
...
QUnit.test('is same with invalid moments', function (assert) {
