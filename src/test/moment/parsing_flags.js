...
QUnit.test('overflow with array', function (assert) {
    //months
...
QUnit.test('overflow without format', function (assert) {
    //months
...
QUnit.test('extra tokens', function (assert) {
...
QUnit.test('extra tokens strict', function (assert) {
...
QUnit.test('unused input', function (assert) {
...
QUnit.test('unused input strict', function (assert) {
...
QUnit.test('chars left over', function (assert) {
...
QUnit.test('invalid month', function (assert) {
...
QUnit.test('empty format array', function (assert) {
...
QUnit.test('weekday mismatch', function (assert) {
    // string with format
