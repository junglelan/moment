...
QUnit.test('utc and local', function (assert) {
...
QUnit.test('creating with utc and no arguments', function (assert) {
...
QUnit.test('creating with utc and a date parameter array', function (assert) {
...
QUnit.test('creating with utc without timezone', function (assert) {
...
QUnit.test('cloning with utc offset', function (assert) {
    var m = moment.utc('2012-01-02T08:20:00');
...
QUnit.test('weekday with utc', function (assert) {
    assert.equal(
