...
QUnit.test('library quarter getter', function (assert) {
...
QUnit.test('quarter setter singular', function (assert) {
...
QUnit.test('quarter setter plural', function (assert) {
    var m = moment([2014, 4, 11]);
...
QUnit.test('quarter setter programmatic', function (assert) {
    var m = moment([2014, 4, 11]);
...
QUnit.test('quarter setter programmatic plural', function (assert) {
    var m = moment([2014, 4, 11]);
...
QUnit.test('quarter setter programmatic abbr', function (assert) {
    var m = moment([2014, 4, 11]);
...
QUnit.test('quarter setter only month changes', function (assert) {
...
QUnit.test('quarter setter bubble to next year', function (assert) {
...
QUnit.test('quarter diff', function (assert) {
...
QUnit.test('quarter setter bubble to previous year', function (assert) {
