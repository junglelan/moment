...
QUnit.test('day of year setters', function (assert) {
...
QUnit.test('iso weeks year starting sunday', function (assert) {
...
QUnit.test('iso weeks year starting monday', function (assert) {
...
QUnit.test('iso weeks year starting tuesday', function (assert) {
...
QUnit.test('iso weeks year starting wednesday', function (assert) {
...
QUnit.test('iso weeks year starting thursday', function (assert) {
...
QUnit.test('iso weeks year starting friday', function (assert) {
...
QUnit.test('iso weeks year starting saturday', function (assert) {
...
QUnit.test('iso weeks year starting sunday formatted', function (assert) {
...
QUnit.test('weeks plural year starting sunday', function (assert) {
...
QUnit.test('iso weeks plural year starting sunday', function (assert) {
...
QUnit.test('weeks setter', function (assert) {
...
QUnit.test('iso weeks setter', function (assert) {
...
QUnit.test('iso weeks setter day of year', function (assert) {
...
QUnit.test('count years with iso week 53', function (assert) {
